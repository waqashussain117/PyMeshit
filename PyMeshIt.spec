...
a = Analysis(
    ...
    hiddenimports=['pkg_resources', 'importlib', 'importlib.util', 'inspect', 'PySide6.QtCore', 'PySide6.QtGui', 'PySide6.QtWidgets', 'shiboken6', 'scipy', 'scipy.sparse', 'scipy.spatial', 'scipy.spatial.distance', 'numpy', 'matplotlib', 'matplotlib.pyplot', 'PIL', 'pyvista', 'pyvista.plotting', 'pyvista.utilities', 'tetgen', 'tetgen.pytetgen', 'tetgen.TetGen', 'triangle', 'triangle.tri', 'triangle.data', 'triangle.plot', 'itertools', 'gc', 'atexit', 'logging', 're', 'time', 'os', 'sys', 'Pymeshit', 'Pymeshit.intersection_utils', 'Pymeshit.tetra_mesh_utils', 'Pymeshit.core', 'typing', 'collections', 'collections.abc'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
